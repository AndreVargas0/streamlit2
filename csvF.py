...
if df is not None and df_stations is not None:
    ...
    # Substituindo KNeighborsRegressor por RandomForestRegressor
    rf = RandomForestRegressor(n_estimators=100, random_state=42)  # 100 árvores no Random Forest
        ...
        for hour in hours:
            for minute in minutes:
                for day in days_of_week:
                    ...
                    predicted_bikes = rf.predict(input_data_scaled)  # Usando o modelo RandomForest
    ...
    output_csv_path = 'previsoes_bicicletas_15min_rf.csv'
