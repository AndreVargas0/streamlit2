...
if df is not None and df_stations is not None:
    ...
    # Substituindo GradientBoostingRegressor por XGBRegressor
    xgb = XGBRegressor(n_estimators=100, random_state=42, objective='reg:squarederror')  # 100 árvores no XGBoost
        ...
        for hour in hours:
            for minute in minutes:
                for day in days_of_week:
                    ...
                    predicted_bikes = xgb.predict(input_data_scaled)  # Usando o modelo XGBoost
    ...
    output_csv_path = 'previsoes_bicicletas_15min_xgb.csv'
