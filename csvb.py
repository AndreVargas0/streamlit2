...
if df is not None and df_stations is not None:
    ...
    # Substituindo RandomForestRegressor por GradientBoostingRegressor
    gb = GradientBoostingRegressor(n_estimators=100, random_state=42)  # 100 árvores no Gradient Boosting
        ...
        for hour in hours:
            for minute in minutes:
                for day in days_of_week:
                    ...
                    predicted_bikes = gb.predict(input_data_scaled)  # Usando o modelo Gradient Boosting
    ...
    output_csv_path = 'previsoes_bicicletas_15min_gb.csv'
